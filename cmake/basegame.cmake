...
if(BUILD_GAME_LIBRARIES)
    ...
    target_compile_definitions( ${CGAME_MODULE_BINARY_BASEGAME} PRIVATE CGAME $<$<BOOL:${BUILD_STANDALONE}>:STANDALONE>)
    ...
    target_compile_definitions( ${GAME_MODULE_BINARY_BASEGAME} PRIVATE QAGAME $<$<BOOL:${BUILD_STANDALONE}>:STANDALONE>)
    ...
    target_compile_definitions( ${UI_MODULE_BINARY_BASEGAME} PRIVATE UI $<$<BOOL:${BUILD_STANDALONE}>:STANDALONE>)
